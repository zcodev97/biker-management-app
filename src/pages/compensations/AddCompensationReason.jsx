...
function AddCompensationReasonPage() {
  ...
  async function addCompensationReason() {
    ...
    fetch(
      Biker_System_URL +
        "compensation/add_compensation_reason?compensation_reason_data=" +
        reason,
      {
        method: "POST",
        headers: {
      ...
      .then((data) => {
        // console.log(data);
        alert("Compensation Reason added 😁");
        navigate("/compensations_reasons");
      })
      .catch((error) => {
        console.log(error);
        alert("Error In Adding Compensation Reason, see console log 😕");
      });
  }
...
export default AddCompensationReasonPage;
